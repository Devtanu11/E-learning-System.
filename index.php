...
{
     extract($_POST);
     $query="INSERT INTO admin (fullname,email,password) VALUES ('$fullname','$email','$password')";
     $result=mysqli_query($conn1,$query);
     if($result==true)
     {
          echo '<script>alert("Your data is with us")</script>';
     }
     else
     {
          echo "fail";
...
<head>
     ...
     <title>DISTANCE LEARNING PROGRAM</title>
<!-- 
                              ...
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-6 col-sm-12">
                                             ...
                                             <h3>We use Projectors and computers to teach you and we also conduct zoom classes for our online students <a rel="nofollow" href="https://www.facebook.com/templatemo"></a> page.</h3>
               ...
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="feature-thumb">
                              ...
                              <p>Known is free education HTML Bootstrap . You can modify in any way .</p>
                         </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="feature-thumb">
                              <span>02</span>
                              <h3>Books & Library</h3>
                              <p>It will help you to learn HTML.</p>
                         </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="feature-thumb">
                              ...
                              <p>You will learn Frontend and Backend in this course.</p>
                         </div>
                    </div>
                         ...
                         <div class="about-info">
                              ...
                              <figure>
                                   ...
                                   <figcaption>
                                        ...
                                        <p>We are providing the international trainers in our course.</p>
                                   </figcaption>
                              </figure>
                              ...
                              <figure>
                                   ...
                                   <figcaption>
                                        ...
                                        <p>We will give you international certificate that would help you a lot.</p>
                                   </figcaption>
                              </figure>
                              ...
                              <figure>
                                   ...
                                   <figcaption>
                                        ...
                                        <p>Here you will find one scheme of free for 3 months.</p>
                                   </figcaption>
                              </figure>
                         </div>
                    </div>
                    ...
                    <div class="col-md-offset-1 col-md-4 col-sm-12">
                         <div class="entry-form">
                              <form method="post">
                                   ...
                                   <button class="submit-btn form-control" id="form-submit">Signup</button>
                              </form>
                              <h4><a href="display1.php"><input type="button"  class="btn btn-primary" value="View users(For admin)"></a></h4>
                         </div>
                    </div>
                                   ...
                                   <div class="item">
                                        <div class="courses-thumb">
                                             ...
                                             <div class="courses-detail">
                                                  ...
                                                  <p>You can apply for the Social Media Managment.</p>
                                             </div>
                                   ...
                                   <div class="item">
                                        <div class="courses-thumb">
                                             ...
                                             <div class="courses-detail">
                                                  ...
                                                  <p>You can apply for the Graphic & Web Design .</p>
                                             </div>
                                   ...
                                   <div class="item">
                                        <div class="courses-thumb">
                                             ...
                                             <div class="courses-detail">
                                                  ...
                                                  <p>You can apply for the Marketing communication.</p>
                                             </div>
                                   ...
                                   <div class="item">
                                        <div class="courses-thumb">
                                             ...
                                             <div class="courses-detail">
                                                  ...
                                                  <p>You can apply for the summer trainning for kid also.</p>
                                             </div>
                                   ...
                                   <div class="item">
                                        <div class="courses-thumb">
                                             ...
                                             <div class="courses-detail">
                                                  ...
                                                  <p>You can apply for the Business &amp Management</p>
                                             </div>
                         ...
                         <div class="owl-carousel owl-theme owl-client">
                              ...
                              <div class="col-md-4 col-sm-4">
                                   <div class="item">
                                        ...
                                        <p>There is chance that you will become a Art Director</p>
                                        <div class="tst-rating">
                                             <i class="fa fa-star"></i>
                                             <i class="fa fa-star"></i>
                                             <i class="fa fa-star"></i>
                              ...
                              <div class="col-md-4 col-sm-4">
                                   <div class="item">
                                        ...
                                        <p>There is chance to become a web developer ,so don't waste your chance hurry.</p>
                                        <div class="tst-rating">
                                             <i class="fa fa-star"></i>
                                             <i class="fa fa-star"></i>
                                             <i class="fa fa-star"></i>
               ...
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                         <div class="footer-info">
                              ...
                              <address>
                                   <p>you have to pay the 1800 in advance<br> Then you have to give the 1200 after ending your course.</p>
                              </address>
                    ...
                    <div class="col-md-4 col-sm-6">
                         <div class="footer-info">
                              ...
                              <address>
                                   <p>+918324433178</p>
                                   <p><a href="mailto:youremail.co">DangerNudes.co.in</a></p>
                              </address>
